      ...
      <div style={{
        ...
        <div style={{ position: "relative", flex: 1 }}>
          <div style={{
            ...
            borderRadius: 24, height: isMobile ? 260 : 440,
            overflow: "hidden", border: "1px solid #bfdbfe",
          }}>
            <img
              src={fragola}
              alt="Fragola AMA Fruits"
              style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }}
            />
          </div>
          <div style={{
            position: "absolute", bottom: isMobile ? -20 : -28, right: isMobile ? 12 : -28,
            background: "linear-gradient(135deg, #1e40af, #2563eb)",
            borderRadius: 16, padding: isMobile ? "16px 20px" : "28px 32px",
            color: "white", boxShadow: "0 12px 40px rgba(30,64,175,0.4)",
          }}>
            <p style={{ fontSize: isMobile ? 28 : 42, fontWeight: 800, margin: 0, lineHeight: 1 }}>100+</p>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 18, marginTop: isMobile ? 16 : 0 }}>
          <p style={{ color: "#1e40af", fontWeight: 700, fontSize: 12, textTransform: "uppercase", letterSpacing: "0.2em", margin: 0 }}>
            {t("about.badge")}
          </p>
          <h2 style={{ fontSize: isMobile ? "1.6rem" : "clamp(1.8rem, 3vw, 2.6rem)", fontWeight: 800, color: "#111827", margin: 0, lineHeight: 1.25 }}>
            {t("about.title")}
          </h2>
          <div style={{ width: 48, height: 4, background: "#1e40af", borderRadius: 2 }} />
          <p style={{ color: "#6b7280", lineHeight: 1.85, margin: 0, fontSize: isMobile ? 14 : 15 }}>
            {t("about.description")}
          </p>
